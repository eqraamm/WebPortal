...
<body
    class="{{ (Session::get('sidebar') == 'top-nav') ? 'hold-transition layout-top-nav layout-fixed text-s' : 'hold-transition sidebar-mini layout-fixed text-s' }}">
    <!-- Site wrapper -->
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <div class="{{session('sidebar') == 'top-nav' ? 'container' : 'container-fluid'}}">
                ...
                <a href="#" class="navbar-brand">
                    <img src="{{asset('dist/img/company_logo.png')}}" alt="AdminLTE Logo"
...
=======
>>>>>>> 1d515371456adffbb7d2151c6bc34ec7c4450da7
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            <!-- Brand Logo -->
            <a href="#" class="brand-link">
                <img src="{{asset('dist/img/company_logo.png')}}" alt="Company Logo" class="brand-image"
                    style="opacity: .8">
                <span class="brand-text font-weight-dark">{{config('app.COMPANYNAME')}}</span>
                <!-- <span class="brand-text font-weight-dark">ACA INSURANCE</span> -->
            </a>
...
=======
               ...
               with font-awesome or any other icon font library -->
                        @if (session('Role') == 'MARKETING OFFICER')
                        <li
                            class="{{ (Session::get('sidebar') == 'master') ? 'nav-item menu-is-opening menu-open' : 'nav-item' }}">
                            <a href="#"
                                class="{{ (Session::get('sidebar') == 'master') ? 'nav-link active' : 'nav-link' }}">
                                <i class="nav-icon fas fa-cog"></i>
                                <p>
                                    Master
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('master.ShowSysUser')}}"
                                        class="{{ (Session::get('sidebar') == 'master' && Session::get('sidebar-tree') == 'sysuser') ? 'nav-link active' : 'nav-link' }}">
                                        <i class="fas fa-users nav-icon"></i>
                                        <p>{{ (Session::get('Role') == 'ADMIN') ? 'User' : 'Business Source'}}</p>
                                    </a>
                                </li>
                        ...
                        <li class="{{ Session::get('sidebar') == 'dashboard' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="{{ route('dashboard')}}"
                                class="{{ Session::get('sidebar') == 'dashboard' ? 'nav-link active' : 'nav-link' }}">
                                <!-- <a href="{{ route('dashboard')}}" class="{{ Session::get('sidebar') == 'dashboard' ? 'nav-link active' : 'nav-link' }}"> -->
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Dashboard
                        ...
                        <li class="{{ Session::get('sidebar') == 'profile' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="{{ route('profile')}}"
                                class="{{ Session::get('sidebar') == 'profile' ? 'nav-link active' : 'nav-link' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Client
                                </p>
                        ...
                        <li class="{{ Session::get('sidebar') == 'sppa' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="{{ route('policy.transaction')}}"
                                class="{{ Session::get('sidebar') == 'sppa' ? 'nav-link active' : 'nav-link' }}">
                                <i class="nav-icon fas fa-copy"></i>
                                <p>
                                    SPPA
                                </p>
                        ...
                        <li class="{{ Session::get('sidebar') == 'survey' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="survey"
                                class="{{ Session::get('sidebar') == 'survey' ? 'nav-link active' : 'nav-link' }}">
                                <i class="nav-icon fas fa-video"></i>
                                <p>
                                    Survey
                                </p>
                        ...
                        @if (config('app.ShowStoredData'))
                        <li
                            class="{{ (Session::get('sidebar') == 'stored-data' && (Session::get('sidebar-tree') == 'stored-policy' || Session::get('sidebar-tree') == 'stored-document')) ? 'nav-item menu-is-opening menu-open' : 'nav-item' }}">
                            <a href="#"
                                class="{{ (Session::get('sidebar') == 'stored-data' && (Session::get('sidebar-tree') == 'stored-policy' || Session::get('sidebar-tree') == 'stored-document')) ? 'nav-link active' : 'nav-link' }}">
                                <i class="nav-icon fas fa-chart-pie"></i>
                                <p>
                                    Stored Data
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('storeddata.showpolicy')}}"
                                        class="{{ (Session::get('sidebar') == 'stored-data' && Session::get('sidebar-tree') == 'stored-policy') ? 'nav-link active' : 'nav-link' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Policy</p>
                                    </a>
                                </li>
...
=======
                        ...
                        @endif
                        @if (session('Role') == 'PRODUCT OWNER' || session('Role') == 'BRANCH')
                        <li class="{{ Session::get('sidebar') == 'faq' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="{{ route('faqlist')}}"
                                class="{{ Session::get('sidebar') == 'faq' ? 'nav-link active' : 'nav-link' }}">
                        ...
                        <li
                            class="{{ Session::get('sidebar') == 'approvalListSPPA' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="{{ route('approvalListSPPA')}}"
                                class="{{ Session::get('sidebar') == 'approvalListSPPA' ? 'nav-link active' : 'nav-link' }}">
                        ...
                        <li
                            class="{{ Session::get('sidebar') == 'training_class' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="{{ route('trainingclass')}}"
                                class="{{ Session::get('sidebar') == 'training_class' ? 'nav-link active' : 'nav-link' }}">
                                <i class="nav-icon fas fa-chalkboard-teacher"></i>
                                <p>
                                    Training Class
                                </p>
                        ...
                        @endif
                        @if (session('Role') == 'AGENT' || session('Role') == 'PRODUCT OWNER')
                        <li class="{{ Session::get('sidebar') == 'faq' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="{{ route('faqlist')}}"
                                class="{{ Session::get('sidebar') == 'faq' ? 'nav-link active' : 'nav-link' }}">
                                <i class="nav-icon fas fa-question"></i>
                        ...
                        <li
                            class="{{ Session::get('sidebar') == 'learningobject' ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="{{ route('learningobject')}}"
                                class="{{ Session::get('sidebar') == 'learningobject' ? 'nav-link active' : 'nav-link' }}">
                                <i class="nav-icon fas fa-chalkboard"></i>
                                <p>
                                    Materi
                                </p>
        ...
        <!-- Loading -->
        <div class="modal" id="loadMe" tabindex="-1" role="dialog" aria-labelledby="loadMeLabel" data-backdrop="static"
...
>>>>>>> 1d515371456adffbb7d2151c6bc34ec7c4450da7
        ...
        <div class="modal fade" id="modal-general" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div id="class-modal-dialog" class="modal-dialog">
                <div class="modal-content">
                    <div id="div-overlay-modal" style="display:none">
                        <div style="position:absolute; top:0.1%; left:0.1%;" class="overlay"><i
                                style="position:absolute; left:50%; top:50%; margin-top:-25px; margin-left:-25px;"
                                class="fas fa-2x fa-sync fa-spin"></i></div>
                    </div>
                    <div class="modal-header">
                        <h4 class="modal-title" id="modaltitle"></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
