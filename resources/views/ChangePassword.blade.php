...
<head>
  ...
  <title>{{config('app.COMPANYNAME')}} Insurance | Change Password</title>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form method="post">
        ...
        <div class="row">
          <div class="col-12">
            <button type="submit" id="btn-changepassword" class="btn btn-primary btn-block">Change password</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
